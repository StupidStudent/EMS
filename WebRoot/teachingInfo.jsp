...
<!--breadcrumbs-->
  <div id="content-header">
  	<div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">基础数据管理</a> <a href="#" class="current">教学内容信息</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>教学内容信息</h5>
                            ...
                            <button class="btn btn-warning btn-mini button">导出</button>
                            <button class="btn btn-warning btn-mini button">导入</button>
          </div>
...
<li><form action="teachingInfo.jsp" onsubmit="makeNewWindow()"><button Style="width: 60px; height: 35px;background-color: #FF7F50;color:#F0F8FF;border-style:none;margin-left:250px;">确定</button></form></li>      
            </ul>
        </div>
        </div>
