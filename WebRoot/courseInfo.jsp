...
<!--breadcrumbs-->
  <div id="content-header">
  	<div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">基础数据管理</a> <a href="#" class="current">课程信息</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>课程信息</h5>
                 <form action="insertCourseInfo.jsp"><button class="btn btn-warning btn-mini button">添加</button></form>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <label>课程编号</label><form action="courseInfo">
             	  <input type="text" name="courseId" id="course"/><br>
  			 ...
  			 <li>
					<c:forEach items="${course }" var="course">
						<h1 id="${course.getCourseId() }">课程名:${course.getName() } </h1><br>
						<h1 id="${course.getCourseId() }">任课教师:${course.getInstruction() } </h1><br>
						<h1 id="${course.getCourseId() }">教学计划:${course.getTeachPlan() } </h1><br>
					</c:forEach>
			 </li>
