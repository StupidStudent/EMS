...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">考务成绩管理</a> <a href="#" class="current">成绩录入</a></div>
  </div>
  <!--End-breadcrumbs-->
          ...
          <div class="controls">
            <select name="select" id="profession">
            	<c:forEach items="${ professions}" var="profession">
            		<option id="${profession.getProId() }">${profession.getName() }</option>
            	</c:forEach>
            </select>
          </div>
        </div>
