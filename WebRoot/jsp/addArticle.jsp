		...
		<div id="main">
			<div id="breadCrumb">
				<img align="absMiddle" src="img/home.gif"> <a
					href="main">论坛</a> » 发表新主题
			</div>
			<div class="c"></div>
			<div class="t z">
				<form id="jvForm" action="submitArticle"
					...
					<table cellspacing="0" cellpadding="0" width="100%" align="center">
						<tbody>
							...
							<tr>
								...
								<td>
										<!-- umeditor编辑器 start -->
										<script type="text/plain" id="myEditor" name="content" style="width:99%;height:100%;">
										</script> 
										<!-- umeditor编辑器 end -->
								</td>
							</tr>
