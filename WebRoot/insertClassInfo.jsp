...
<!--breadcrumbs-->
  <div id="content-header">
  	<div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">基础数据管理</a> <a href="#" class="current">班级信息</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>班级信息</h5>
            <form action="insertClassInfo.jsp"><button class="btn btn-warning btn-mini button">添加</button></form>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <form action="insertClass.jsp">
             		<label>班级编号</label>
             	  	<input type="text" name="classId" id="classTeam"/><br>
             	  	
             	  	<label>专业代号</label>
             	  	<input type="text" name="proId" id="classTeam"/><br>
             	  	<label>教师</label>
             	  	<input type="text" name="instructor" id="classTeam"/><br>
             	  	<label>专业名称</label>
             	  	<input type="text" name="name" id="classTeam"/><br>
             	  	<label>年级</label>
             	  	<input type="text" name="grade" id="classTeam"/><br>
