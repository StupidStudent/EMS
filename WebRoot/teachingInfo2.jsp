...
<li><form action="teachingInfo2.jsp" onsubmit="makeNewWindow()"><button Style="width: 60px; height: 35px;background-color: #FF7F50;color:#F0F8FF;border-style:none;margin-left:250px;">确定</button></form></li>       
            </ul>
        </div>
        </div>
