...
<link href="css/zhong.css" rel="stylesheet"/>
  ...
  <ul>
   ...
   <li class="submenu"><a href="#"><i class="icon icon-th-list"></i> <span>基础数据管理</span> </a>
     ...
     <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>教务管理</span> </a>
      <ul>
        <li><a href="teachPlan1.html">教学计划</a></li>
        <li><a href="teachPlan2.html">教学任务</a></li>
        <li><a href="schedule.html">课表管理</a></li>
		<li><a href="bookManage.html">教材征订</a></li>
		<li><a href="experiment.html">实验项目</a></li>
      </ul>
    </li>
     <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>考务成绩管理</span> </a>
      <ul>
        <li><a href="examSchema.jsp">考试方案</a></li>
        <li><a href="examArrange.html">考试安排</a></li>
        <li><a href="examInfo.html">考务信息</a></li>
        <li><a href="examCheck.html">试卷审批</a></li>
        <li><a href="mark.html">成绩管理</a></li>
      </ul>
    </li>
  </ul>
</div>
...
<div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
			...
			<c:if test="${sessionScope.kind != '学生' }">
				<a class="btn btn-success btn-mini button" href="addBook?classId=${classId}">添加</a>
			</c:if>
          </div>
