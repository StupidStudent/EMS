      ...
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <form action="insertCourse.jsp">
             		<label>课程编号</label>
             	  	<input type="text" name="courseId" id="course"/><br>
             	  	
             	  	<label>课程名称</label>
             	  	<input type="text" name="name" id="course"/><br>
             	  	<label>任课教师</label>
             	  	<input type="text" name="instruction" id="course"/><br>
             	  	<label>教学计划</label>
             	  	<input type="text" name="teachPlan" id="course"/><br>
