...
<!--breadcrumbs-->
  <div id="content-header">
  	<div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">基础数据管理</a> <a href="#" class="current">学生信息</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>学生信息</h5>
                            <form action="insertStudentInfo.jsp"><button class="btn btn-warning btn-mini button">添加</button></form>            				
                            <form action="updateStudentInfo.jsp"><button class="btn btn-warning btn-mini button">更新</button></form>
                            <form action="delStudentInfo.jsp"><button class="btn btn-warning btn-mini button">删除</button></form>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <label>学生编号</label><form action="studentInfo">
             	  <input type="text" name="stuId" id="student"/><br>
  			 ...
  			 <li>
					<c:forEach items="${student }" var="student">
						<h1 id="${student.getStuId() }">姓名:${student.getName() } </h1><br>
						<h1 id="${student.getStuId() }">年龄:${student.getAge() } </h1><br>
						<h1 id="${student.getStuId() }">地址:${student.getAddress() } </h1><br>
					</c:forEach>
			 </li>
