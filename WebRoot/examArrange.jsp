...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">考务成绩管理</a> <a href="#" class="current">考试安排</a></div>
  </div>
  <!--End-breadcrumbs-->
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <form action="saveExam" method="post">
             	 　考试科目：　 <input type="text" name="course" id="student"/><br><br>
             	 　考试科室：　 <input type="text" name="classroom" id="student"/><br><br>
             	　 监考人员：  　<input type="text" name="teacher" id="student"/><br><br>
             	　 考试时间：  　<input type="text" name="time” id="student"/><br><br>
