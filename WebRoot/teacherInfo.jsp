...
<!--breadcrumbs-->
  <div id="content-header">
  	<div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">基础数据管理</a> <a href="#" class="current">教师信息</a></div>
  </div>
<!--End-breadcrumbs-->
...
<div class="widget-box">
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
            <h5>教师信息</h5>
                            <form action="insertTeacherInfo.jsp"><button class="btn btn-warning btn-mini button">添加</button></form>
                            <form action="updateTeacherInfo.jsp"><button class="btn btn-warning btn-mini button">更新</button></form>
                            <form action="delTeacherInfo.jsp"><button class="btn btn-warning btn-mini button">删除</button></form>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <label>教师编号</label><form action="teacherInfo" onsubmit="makeNewWindow()">
             	  <input type="text" name="teaId" id="teacher"/><br>
             	  <button Style="width: 60px; height: 35px;background-color: #FF7F50;color:#F0F8FF;border-style:none;">确定</button>
             	  </form>
             </li>

  			 <li>
					<c:forEach items="${teacher }" var="teacher">
						<h1 id="${teacher.getTeaId() }">姓名:${teacher.getName() } </h1><br>
						<h1 id="${teacher.getTeaId() }">年龄:${teacher.getAge() } </h1><br>
						<h1 id="${teacher.getTeaId() }">rank:${teacher.getRank() } </h1>
					</c:forEach>
			 </li>
