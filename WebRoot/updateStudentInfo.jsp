      ...
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <form action="updateStudentInfo">
             		<label>学生编号</label>
             	  	<input type="text" name="stuId" id="student"/><br>
             	  	<label>班级编号</label>
             	  	<input type="text" name="classId" id="student"/><br>
             	  	<label>用户编号</label>
             	  	<input type="text" name="userId" id="student"/><br>
             	  	<label>姓名</label>
             	  	<input type="text" name="name" id="student"/><br>
             	  	<label>年龄</label>
             	  	<input type="text" name="age" id="student"/><br>
             	  	<label>地址</label>
             	  	<input type="text" name="address" id="student"/><br>
             	  <button Style="width: 60px; height: 35px;background-color: #FF7F50;color:#F0F8FF;border-style:none;">更新</button>
             	  </form>
             </li>
