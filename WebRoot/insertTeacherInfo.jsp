      ...
      <div class="widget-title"> <span class="icon"> <i class="icon-file"></i> </span>
          ...
          <form action="#" method="get" class="form-horizontal">
            <div class="control-group">
             ...
             <li> <form action="insertTea.jsp">
             		<label>教师编号</label>
             	  	<input type="text" name="teaId" id="teacher"/><br>
             	  	
             	  	<label>用户编号</label>
             	  	<input type="text" name="userId" id="teacher"/><br>
             	  	<label>姓名</label>
             	  	<input type="text" name="name" id="teacher"/><br>
             	  	<label>年龄</label>
             	  	<input type="text" name="age" id="teacher"/><br>
             	  	<label>rank</label>
             	  	<input type="text" name="rank" id="teacher"/><br>
             	  <button Style="width: 60px; height: 35px;background-color: #FF7F50;color:#F0F8FF;border-style:none;">添加</button>
             	  </form>
             </li>
