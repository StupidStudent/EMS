...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="Go to Home"><i class="icon-home"></i>首页</a> <a href="#">教务管理</a> <a href="#" class="current">教学任务</a></div>
  </div>
  <!--End-breadcrumbs-->
    ...
    <div class="widget-box">
      ...
      <form action="#" method="get" class="form-horizontal">
        <div class="control-group">
          <label class="control-label">主讲教师</label>
          <div class="controls">
            <select name="select">
